...
Основные настройки запуска лежат в файле `.env`: порты, доступы к MinIO/PostgreSQL, параметры Kafka, Spark и обработки снимков. Если файла нет, создайте его из `.env.example`.
